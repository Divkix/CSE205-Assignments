...
//  Description: The Aircraft class manages information of an aircraft
...
public class Aircraft {
    ...
    /**
     * 
     * @param _type                 Type (Fighter Jet, Bomber - Propeller Type,
     *                              Bomber - Jet
     ...
     */
    public Aircraft(String _type, String _name, int _bombCarryingCapacity, int _attackPower, int _stealthIndex) {
        this.type = _type;
        this.name = _name;
